...
const ClimbingCharacter = () => {
    ...
    // Materials
    const suitMaterial = <meshStandardMaterial color="#181025" roughness={0.4} metalness={0.6} />; // Dark indigo suit
    const accentMaterial = <meshStandardMaterial color="#c084fc" emissive="#c084fc" emissiveIntensity={2} toneMapped={false} />; // Violet glow
