...
const HowItWorks = () => {
    const [animationPhase, setAnimationPhase] = useState<'builder' | 'path' | 'code' | 'roadmap'>('builder');
    ...
    useEffect(() => {
        const cycle = async () => {
            ...
            await new Promise(r => setTimeout(r, 6000)); // Wait for builder animation + click

            // Path Phase
            setAnimationPhase('path');
            await new Promise(r => setTimeout(r, 4000)); // Wait for path animation
                            ...
                            {animationPhase === 'builder' ? (
                                ...
                                >
                                    ...
                                    <motion.div
                                        ...
                                        style={{ background: 'rgba(139, 92, 246, 0.1)', border: '1px solid rgba(139, 92, 246, 0.3)', borderRadius: '8px', padding: '1rem' }}
                                    >
                                        <div style={{ fontSize: '0.8rem', color: '#c084fc', marginBottom: '0.5rem' }}>Module 2: Advanced Patterns</div>
                                        {/* Lessons */}
                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                            {[1, 2].map(i => (
                                                <motion.div
                                ...
                                <motion.div
                                    ...
                                    exit={{ opacity: 0 }}
                                    transition={{ duration: 0.5 }}
                                    style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0f0f13' }}
                                >
                                    <div style={{ position: 'relative', width: '80%', height: '100px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                        {/* Horizontal Line */}
                                        <div style={{ position: 'absolute', top: '50%', left: 0, right: 0, height: '4px', background: 'rgba(139, 92, 246, 0.3)', transform: 'translateY(-50%)', zIndex: 0 }} />
                                        ...
                                        <motion.div
                                            ...
                                            animate={{ scaleX: 1 }}
                                            transition={{ duration: 1.5, ease: "easeInOut" }}
                                            style={{ position: 'absolute', top: '50%', left: 0, right: 0, height: '4px', background: '#8b5cf6', transform: 'translateY(-50%)', transformOrigin: 'left', zIndex: 0, boxShadow: '0 0 10px rgba(139, 92, 246, 0.5)' }}
                                        />
                                        ...
                                        <motion.div
                                            ...
                                            animate={{ scale: 1 }}
                                            transition={{ delay: 0.2 }}
                                            style={{ position: 'relative', zIndex: 1, width: '24px', height: '24px', borderRadius: '50%', background: '#020205', border: '3px solid #8b5cf6', boxShadow: '0 0 15px rgba(139, 92, 246, 0.3)' }}
                                        />
                                        ...
                                        <div style={{ position: 'relative', zIndex: 1 }}>
                                            <motion.div
                                                ...
                                                style={{ position: 'absolute', top: '50%', left: '50%', width: '50px', height: '50px', borderRadius: '50%', background: 'rgba(139, 92, 246, 0.2)', transform: 'translate(-50%, -50%)', zIndex: -1 }}
                                            />
                                            <motion.div
                                                initial={{ scale: 0 }}
                                                animate={{ scale: 1 }}
                                                transition={{ delay: 0.8 }}
                                                style={{ width: '32px', height: '32px', borderRadius: '50%', background: '#020205', border: '4px solid #8b5cf6', boxShadow: '0 0 20px rgba(139, 92, 246, 0.6)' }}
                                            />
                                        </div>
                                    ...
                                    <div style={{ position: 'absolute', bottom: '2rem', color: '#a0a0a0', fontSize: '0.9rem' }}>Your Learning Path</div>
                                </motion.div>
                            ) : animationPhase === 'code' ? (
                                <motion.div
                                    key="code"
                                ...
                                >
                                    ...
                                    <div style={{ position: 'relative', width: '100%', height: '400px', display: 'flex', justifyContent: 'center' }}>
                                        ...
                                        <motion.div
                                            ...
                                            style={{
                                                position: 'absolute', top: '140px', left: '25%', transform: 'translateX(-50%)',
                                                width: '160px', height: '50px',
                                                background: 'linear-gradient(145deg, #1a1a1a, #050505)',
                                        ...
                                        <motion.div
                                            ...
                                            transition={{ duration: 0.5, delay: 1.0 }}
                                            style={{
                                                position: 'absolute', top: '140px', left: '75%', transform: 'translateX(-50%)',
                                                width: '160px', height: '50px',
                                                background: 'linear-gradient(145deg, #1a1a1a, #050505)',
                                                border: '1px solid rgba(167, 139, 250, 0.2)',
                                                borderRadius: '12px',
                                        ...
                                        <motion.div
                                            ...
                                            style={{
                                                position: 'absolute', top: '260px', left: '25%', transform: 'translateX(-50%)',
                                                width: '160px', height: '50px',
                                                background: 'linear-gradient(145deg, #1a1a1a, #050505)',
                                                borderRadius: '10px',
                                        ...
                                        <motion.div
                                            ...
                                            transition={{ duration: 0.5, delay: 1.8 }}
                                            style={{
                                                position: 'absolute', top: '260px', left: '75%', transform: 'translateX(-50%)',
                                                width: '160px', height: '50px',
                                                background: 'linear-gradient(145deg, #1a1a1a, #050505)',
                                                borderRadius: '10px',
                                                zIndex: 2, border: '1px solid rgba(75, 85, 99, 0.3)',
